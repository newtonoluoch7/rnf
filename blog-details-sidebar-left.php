                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title text-center">
                                <h1>Blog Details Sidebar Left</h1>
                            </div>
                            <div class="breadcrumbs-area  text-center">
                                <ol class="breadcrumbs">
                                    <li><a href="#">Home</a></li>
                                    <li class="active">Blog Details Sidebar Left</li>
                                </ol>
                            </div>
                            <div class="back-home">
                        ...
                        <div class="col-lg-8 order-lg-2 order-1">
                            <div class="blog-details single-blog mb-30">
                                ...
                                <div class="blog-info">
                                    ...
                                    <div class="comment">
                                        <a href="#"><i class="fa fa-user" aria-hidden="true"></i> By: Admin</a>
                                        <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i> 24 may</a>
                                ...
                                <div class="blo-image-and-date">
                                    <img src="img/blog/baby2.jpg" alt="">
                                </div>
                                <div class="blog-text">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="coment-image">
                                                <a href="#"><img src="img/blog/avatar-01.jpg" alt=""></a>
                                            </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="coment-image">
                                                        <a href="#"><img src="img/blog/avatar-02.jpg" alt=""></a>
                                                    </div>
                                                    <div class="comment-heading">
                                                        <h5><a href="#">Jhon Doe</a></h5>
                                                        <p>26 Dec 2016, 15:20</p>
