                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title text-center">
                                <h1>EVENTS sidebar Left</h1>
                            </div>
                            <div class="breadcrumbs-area  text-center">
                                <ol class="breadcrumbs">
                                    <li><a href="#">Home</a></li>
                                    <li class="active">Events sidebar Left</li>
                                </ol>
                            </div>
                            <div class="back-home">
                ...
                <div class="container">
                    <div class="row">
                                ...
                                <div class="single-event mb-90 row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="event-text">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ut tristique massa. Morbi in ex orci.</p>
                        ...
                        <div class="col-lg-3 order-lg-1 order-2">
                            <div class="event-sidebar mt-sm-50">
