                            ...
                            <div class="row">
                                    ...
                                    <div class="footer-widget widget-two">
                                        ...
                                        <nav>
                                            <ul>
                                                ...
                                                <li><a href="elements-our-gallery.php">Our Gallery</a></li>
                                                <li><a href="donate.php">Donate</a></li>
                                                <li><a href="blog.php">Blog</a></li>
                                                <li><a href="events.php">Events</a></li>
                                                <li><a href="elements-our-volunteers.php">Volunteer</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
                                    ...
                                    <div class="footer-widget widget-two">
                                        ...
                                        <nav>
                                            <ul>
                                                ...
                                                <li><a href="talentnaturing.php">Talent Naturing</a></li>
                                                <li><a href="talent-fairs.php">Talent Fairs</a></li>
                                                <li><a href="fellowships.php">RNF Fellowships</a></li>
                                                <li><a href="exchange.php">Exchange programs</a></li>
                                                <li><a href="community.php">Community Service</a></li>
                                                <li><a href="women_youths.php">Women, Girls & Youths</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="footer-widget widget-four">
                                        ...
                                        <div class="widget-about-content">
                                            <p>Kindly share your mail to be receiving our newslaters and events updates</p>
                                        </div>
                                        <div class="newslater">
