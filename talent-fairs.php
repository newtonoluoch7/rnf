                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="breadcrumbs-area  text-center">
                                <ol class="breadcrumbs">
                                    <li><a href="#">Home</a></li>
                                    <li class="active">Talent Fairs</li>
                                </ol>
                            </div>
                            <div class="back-home">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="about-content">
                                <p>To sensitize the communities about the importance of talents in child development, RNF holds talent fairs within communities, schools and religious organizations. Our fairs will give children the opportunity to display their various talents and gain recognition for this.
                                    Such events are also used to identify exceptionally gifted children who could be eligible for further development programs that the management shall deem fit based on their capabilities.
                                    Additionally, we use these events to sensitize parents, guardians and teachers on the importance of nurturing their children’s talents. Child talent development does not occur in a vacuum; therefore, it is imperative that we ensure care givers play a part in nurturing children’s talents.
                                    Our fairs shall be themed around appreciating diversity of cultures, family values, responsible leadership, civic duty and avoiding risky lifestyles among others.
                        ...
                        <div class="col-md-6">
                            <div class="about-image">
                                <img src="img/talent samsung.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
